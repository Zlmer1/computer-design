...
def option():
    ...
    parser.add_argument('--data_train_lol_v1'       , type=str, default='/home/comp/20482213/datasets/LOL_v1/our485')
    ...
    parser.add_argument('--data_val_lol_v1'         , type=str, default='/home/comp/20482213/datasets/LOL_v1/eval15/low')
    ...
    parser.add_argument('--data_valgt_lol_v1'       , type=str, default='/home/comp/20482213/datasets/LOL_v1/eval15/high/')
    ...
    parser.add_argument('--val_folder', default='/home/comp/20482213/experiment/Lowlight/retinex/mst_topk_1/', help='Location to save validation datasets')
