...
if __name__ == '__main__':
    ...
    alpha = None
    if ep.lol:
        eval_data = DataLoader(dataset=get_eval_set(r"./eval15_256/low"), num_workers=num_workers, batch_size=1, shuffle=False)
        output_folder = r'./output'
        ##权重文件夹
        if ep.perc:
            weight_path = r"./epoch_490.pth"
        else:
            weight_path = r"./epoch_490.pth"
        ...
        if ep.best_GT_mean:
            weight_path = r"C:\Users\w\Desktop\LOL_v1_epoch_500.pth"
            alpha = 0.84
        elif ep.best_PSNR:
